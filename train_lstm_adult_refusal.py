...
if __name__ == "__main__":
    ...
    traces = data_utils.load_data(os.path.join(lstm_input_dir, f"{model_config.model_name}_adult_refusal_traces.pkl"))
    labels = data_utils.load_data(os.path.join(lstm_input_dir, f"{model_config.model_name}_adult_refusal_labels.pkl"))
    ...
    lstm_model_path = os.path.join(lstm_model_dir, f"{model_config.model_name}_adult_refusal_lstm.pkl")
